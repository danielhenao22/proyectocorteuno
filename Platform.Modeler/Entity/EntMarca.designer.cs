...
namespace Platform.Modeler.Entity
{
	...
	public partial class EntMarcaDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteMARCA(MARCA instance);
		...
		public EntMarcaDataContext() : 
				base(global::Platform.Modeler.Properties.Settings.Default.AlquilerCarrosConnectionString1, mappingSource)
		{
			OnCreated();
		}
		
		public EntMarcaDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public EntMarcaDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public EntMarcaDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public EntMarcaDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
